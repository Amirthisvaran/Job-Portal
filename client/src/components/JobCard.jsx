  ...
  return (
    <div className='border p-6 shadow rounded'>
        ...
        <div className='mt-4 flex gap-4 text-sm'>
            ...
            <button onClick={() => {navigate(`/apply-job/${job._id}`); scrollTo(0,0)}} className='text-gray-500 border border-gray-500 rounded py-2 px-4 cursor-pointer'>Learn more</button>
        </div>
    </div>
  )
}
